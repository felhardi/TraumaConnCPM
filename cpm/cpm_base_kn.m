...
load(fullfile('roi_matrices', 'corr_matrices_kn.mat'));  
load(fullfile('trauma_data', 'trauma_kn.mat'));
...
% save metrics
writematrix(same_pos_mask, 'pos_mask_kn.csv'); % pos mask
writematrix(same_neg_mask, 'neg_mask_kn.csv'); % neg mask
...
%writematrix(behav_pred, 'behav_pred_kn.csv'); % predicted power
%writematrix(behav_pred_pos, 'behav_pred_pos_age.csv'); % predicted pos
%writematrix(behav_pred_neg, 'behav_pred_neg_age.csv'); % predicted neg
